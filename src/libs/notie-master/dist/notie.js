(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["notie"] = factory();
  else root["notie"] = factory();
})(this, function () {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var addToDocument = function addToDocument(element, position) {
          ...
          if (element.listener)
            window.addEventListener("keydown", element.listener);
        ...
        var addOverlayToDocument = function addOverlayToDocument(
          owner,
          position
        ) {
        ...
        var hideAlerts = (exports.hideAlerts = function hideAlerts(callback) {
          var alertsShowing = document.getElementsByClassName(
        ...
        var alert = (exports.alert = function alert(_ref) {
          var _ref$type = _ref.type,
            ...
            position =
              _ref$position === undefined
                ? options.positions.alert || position.top
                : _ref$position;
        ...
        var force = (exports.force = function force(_ref2, callbackArg) {
          var _ref2$type = _ref2.type,
            ...
            buttonText =
              _ref2$buttonText === undefined ? "OK" : _ref2$buttonText,
            callback = _ref2.callback,
            _ref2$position = _ref2.position,
            position =
              _ref2$position === undefined
                ? options.positions.force || position.top
                : _ref2$position;
        ...
        var confirm = (exports.confirm = function confirm(
          ...
          var text = _ref3.text,
            ...
            submitText =
              _ref3$submitText === undefined ? "Yes" : _ref3$submitText,
            _ref3$cancelText = _ref3.cancelText,
            cancelText =
              _ref3$cancelText === undefined ? "Cancel" : _ref3$cancelText,
            submitCallback = _ref3.submitCallback,
            cancelCallback = _ref3.cancelCallback,
            _ref3$position = _ref3.position,
            position =
              _ref3$position === undefined
                ? options.positions.confirm || position.top
                : _ref3$position;
        ...
        var input = function input(
          ...
          var text = _ref4.text,
            ...
            submitText =
              _ref4$submitText === undefined ? "Submit" : _ref4$submitText,
            _ref4$cancelText = _ref4.cancelText,
            cancelText =
              _ref4$cancelText === undefined ? "Cancel" : _ref4$cancelText,
            submitCallback = _ref4.submitCallback,
            cancelCallback = _ref4.cancelCallback,
            _ref4$position = _ref4.position,
            position =
              _ref4$position === undefined
                ? options.positions.input || position.top
                : _ref4$position,
            settings = _objectWithoutProperties(_ref4, [
              "text",
              "submitText",
              "cancelText",
              "submitCallback",
        ...
        var select = (exports.select = function select(
          ...
          var text = _ref5.text,
            ...
            cancelText =
              _ref5$cancelText === undefined ? "Cancel" : _ref5$cancelText,
            cancelCallback = _ref5.cancelCallback,
            choices = _ref5.choices,
            _ref5$position = _ref5.position,
            position =
              _ref5$position === undefined
                ? options.positions.select || position.top
                : _ref5$position;
        ...
        var date = (exports.date = function date(
          ...
          var _ref7$value = _ref7.value,
            ...
            submitText =
              _ref7$submitText === undefined ? "OK" : _ref7$submitText,
            _ref7$cancelText = _ref7.cancelText,
            cancelText =
              _ref7$cancelText === undefined ? "Cancel" : _ref7$cancelText,
            submitCallback = _ref7.submitCallback,
            cancelCallback = _ref7.cancelCallback,
            _ref7$position = _ref7.position,
            position =
              _ref7$position === undefined
                ? options.positions.date || position.top
                : _ref7$position;
          ...
          var updateMonth = function updateMonth(amount) {
            var daysInNextMonth = new Date(
              value.getFullYear(),
              value.getMonth() + amount + 1,
              0
            ).getDate();
            if (value.getDate() > daysInNextMonth)
              value.setDate(daysInNextMonth);
          ...
          elementDateSelectorInner.classList.add(
            options.classes.dateSelectorInner
          );
